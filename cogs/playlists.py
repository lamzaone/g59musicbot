                    ...
                    try:
                        ...
                        if reaction.emoji == '🔀':
                            ...
                            if not ctx.voice_client.is_playing():
                                ...
                                await message.delete()
                                await ctx.send(f'Playlist `{playlist_name}` added to queue')
                                return
            ...
            try:
                if "list=" in query:
                    ...
                    if "watch?v=" in query or 'youtu.be' in query or "youtube.com" in query:
                        message = await ctx.send("This is url/link of a youtube playlist. Do you want to add the entire playlist to your playlist?")
                        await message.add_reaction("✅")
                        await message.add_reaction("❌")
                        try:
